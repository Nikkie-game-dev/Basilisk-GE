...
#pragma region Loading
        ...
        static void BindAndFillVbo(unsigned int VboID, int sizeArray, const float array[]);
        ...
        /// <param name="sizeArray">Size of array to fill buffer with</param>
        /// <param name="array">Array of data</param>
        static void BindAndFillEbo(unsigned int EboId, int sizeArray, const unsigned int array[]);
        ...
        void BindBufferDataUV(unsigned int vbo, int amountVertices, float* arrayData, int verticesBefore, int sizeDataInVbo);
