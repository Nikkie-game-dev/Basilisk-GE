...
namespace basilisk
{
    ...
    constexpr static auto Red = Color(255, 3, 20);
    constexpr static auto Orange = Color(255, 128, 25);
    constexpr static auto Yellow = Color(250, 230, 3);
    constexpr static auto Green = Color(40, 225, 10);
    constexpr static auto Cyan = Color(59, 181, 255);
    constexpr static auto DeepBlue = Color(5, 0, 199);
    constexpr static auto Blue = Color(92, 3, 250);
    constexpr static auto Purple = Color(222, 0, 237);
