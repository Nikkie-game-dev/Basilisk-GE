...
namespace basilisk::utils
{
    ...
    public:
        ...
        explicit Color(const Normalize& normalizedColor) noexcept;
        ...
        Color(unsigned char r, unsigned char g, unsigned char b, float a) noexcept;
