...
namespace basilisk::utils
{
    ...
    Color::Color(const Normalize& normalizedColor) noexcept
    {
    ...
    Color::Color(const unsigned char r, const unsigned char g, const unsigned char b, const float a) noexcept
    {
        this->R = r;
        this->G = g;
        this->B = b;
    ...
    Color::Color(const unsigned char r, const unsigned char g, const unsigned char b) noexcept: 
        R(r), G(g), B(b), A(1.0)
    {
    }
